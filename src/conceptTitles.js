/**
 * Concept titles co-located with Bank curriculum metadata.
 * Prefer generating this alongside generatedBank.js when the bank builder emits concept labels;
 * until then this module is the single owner of Concept display names.
 */
...
export const GENERIC_CONCEPT_TITLES = new Set([
  "Area",
  "Volume",
  "Centroid",
  "Arc length",
